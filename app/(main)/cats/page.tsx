...
export default function Home() {
  ...
  return (
    <>
      <div className="mb-8">
        <h1 className="text-2xl text-center font-semibold tracking-tight">Cats</h1>
        <p className="text-[13px] text-center text-muted-foreground mt-1">Browse the archive.</p>
      </div>
